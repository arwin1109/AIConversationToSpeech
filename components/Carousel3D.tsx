...
import { Play, Pause, Activity, ChevronLeft, ChevronRight, Download } from 'lucide-react';
...
const Carousel3D: React.FC<Carousel3DProps> = ({ 
  ...
  const handleDownload = (e: React.MouseEvent, voice: Voice) => {
    e.stopPropagation();
    const link = document.createElement('a');
    link.href = voice.audioSampleUrl;
    link.download = `${voice.name}-sample.mp3`;
                          ...
                          <div>
                              <div className="flex items-center justify-between mb-2">
                                  ...
                                  <div className="flex items-center gap-2">
                                      {isActive && (
                                          <button
                                              onClick={(e) => handleDownload(e, voice)}
                                              className="p-2 text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-full transition-all"
