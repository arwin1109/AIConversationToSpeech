...
import { Play, Pause, Activity, Download } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="p-1.5 text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-md transition-all opacity-0 group-hover:opacity-100"
